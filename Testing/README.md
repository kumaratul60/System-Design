...
| **6**  | **[A/B Testing & Experimentation](./AB_Testing.md)**                | Client vs Edge vs Server bucketing, deterministic consistent hashing (`CRC32`), FOOC flicker elimination, statistical significance, telemetry.            |
