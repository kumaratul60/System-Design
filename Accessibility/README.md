...
| [**i18n, l10n & RTL Accessibility Architecture Guide**](file:///Users/atulkumarawasthi/projects/SystemDesign/Accessibility/Internationalization_i18n_l10n_a11y.md) | i18n, l10n, RTL & AI a11y         | Native `Intl.*` API, 6-form Plural rules, Screen Reader `lang` sync, BiDi CSS logical properties, and AI accessibility copilot. |
