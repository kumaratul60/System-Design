...
> - **Index:** If you reorder a list, the index stays the same but the data moves. React will reuse the component instance (and its internal state like an input value or a timer) for the *wrong* data.
