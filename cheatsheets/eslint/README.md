...
| 🌐 [**05. Internationalization & i18n**](05-i18n-formatjs.md)                  | `@formatjs`, `i18next`, Native `Intl`    | Plumbing vs Flow architecture, native `Intl.*` formatting matrix, 6-form plural rules, hardcoded JSX string bans, pseudo-locales. |
